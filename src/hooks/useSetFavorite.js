...
const useSetFavorite = (onRemoveFavorite) => {
  ...
  const setFavorite = (id, type) => {
    ...
    fetch('https://api.themoviedb.org/3/account/20941210/favorite', {
      method: 'post',
      headers: { Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5MWZiZTQ5YjY1MWFjODZiODY3M2RiNzQxZDAyMzJkOCIsInN1YiI6IjY1YWZhYzIwMTU4Yzg1MDEwYWEwZTA4OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.4sgFRGgorNIzSpqk6SIlE0XgX2ckY-zEqDKQUqiKTes2', 'content-type': 'application/json' },
